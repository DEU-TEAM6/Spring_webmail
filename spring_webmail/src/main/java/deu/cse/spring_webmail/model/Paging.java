...
public class Paging {
    ...
    public String pagination(){
        ...
        if(pre){
            buffer.append("<span id=pre><a href=main_menu?currentpage=1 title=\"첫 페이지\"> |< </a></span> ");
            buffer.append("<span id=pre><a href=main_menu?currentpage=" + (currentpage - 1) + " title=\"이전 페이지\"> << </a></span> ");
        }
        for (int page = startpage; page <= endpage; page++){
            buffer.append("<span id=page><a href=main_menu?currentpage=" + page + " title=\"페이지 변경\"> " + page + "</a> </span>");
        }
        if(next){
            buffer.append("<span id=pre><a href=main_menu?currentpage=" + (currentpage + 1) + " title=\"다음 페이지\"> >> </a></span> ");
            buffer.append("<span id=last><a href=main_menu?currentpage=" + totalpage + " title=\"마지막 페이지\"> >| </a></span> ");
        }
