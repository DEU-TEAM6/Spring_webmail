<%-- 
    Document   : me_mail.jsp
    Created on : 2023. 4. 6., 오전 11:01:46
    Author     : kkll3
--%>
    ...
    <body>
        ...
        <div id="main">
            <form enctype="multipart/form-data" method="POST" action="write_mail.do" >
                <table summary="내게 쓰기 테이블">
                    <tr>
                        <th id="수신"> 수신 </th>
                        <td> <input type="text" name="to" size="80" value="<%= session.getAttribute("userid") %>" readonly>
                    </tr>
                    <tr>
                        <th id="참조">참조</th>
